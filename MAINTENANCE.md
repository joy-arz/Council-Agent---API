...
#### 1. Missing Error Propagation (routes.rs)
...
#### 4. Session Directory Accumulation
...
#### 5. Regex Tool Call Parsing Fragility
...
2. **Memory Management:** The sliding window memory system (`src/core/memory.rs`) could benefit from configurable window sizes based on task complexity.
